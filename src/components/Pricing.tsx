      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 55% 45% at 25% 0%, rgba(232,84,28,0.2) 0%, transparent 65%)",
            }}
          />
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-0">
            ...
            {/* Left — headline + CTA */}
            <div className="px-10 py-14 md:py-16 flex flex-col justify-between" style={{ borderRight: "1px solid #1e1e1e" }}>
              <div>
                <span
                  className="inline-block text-xs font-semibold px-3 py-1 rounded-full mb-7"
                  style={{ background: "rgba(232,84,28,0.14)", color: "#E8541C" }}
                >
                  Free · No obligation
                </span>
                <h2 className="text-3xl md:text-4xl font-bold leading-tight mb-5" style={{ color: "#fff" }}>
                  Most STR operators have the same problems.{" "}
                  <span style={{ color: "#E8541C" }}>The ones who fix them first win.</span>
                </h2>
                <p className="text-base leading-relaxed mb-9" style={{ color: "#666" }}>
            ...
            {/* Right — what's included + what happens */}
            <div className="px-10 py-14 md:py-16 flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-5">
                  {steps.map((s, i) => (
                    <div key={i} className="flex items-start gap-3.5">
                      ...
                      <div>
                        <p className="text-sm font-semibold" style={{ color: "#ddd" }}>{s.label}</p>
                        <p className="text-xs mt-0.5" style={{ color: "#555" }}>{s.sub}</p>
                      </div>
                    </div>
                  ))}
                </div>
